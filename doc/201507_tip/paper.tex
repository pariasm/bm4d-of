...
%motion-compensated, its spatial slices can have little correlation.
%The same applies to the spatial slices of the principal directions.
...
continuous plots.
%Currently we do not have an explanation for this behaviour
%although it is related to the aggregation:
...
%		corresponds to the maximum PSNR and black to a decay of 1dB below the
%		maximum. 
...
% lower computation time than our method. Running with a
...
% being itself far more complex to one of the stages of V-BM4D.
