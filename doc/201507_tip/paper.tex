...
but yields better results, since more similar patches can be found. We use same 
...
%
Instead, we fix the first stage parameters, both for color and grayscale videos
at
...
\begin{table}
	...
	\begin{tabular}{l | c c | c c }
		...
		$w_x$        &   5    & 5     & 5     & 5    \\
		$n$          & 400    & 100   & 400   & 100  \\
		$r$          & full   & $35 - \frac12(\sigma - 10)$    & full  & $35 - \frac12(\sigma - 10)$   \\
...
\begin{figure*}[htpb!]
	\begin{center}
		...
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-curves_s10_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-curves_s20_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-curves_s30_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-curves_s40_average_mono.eps}\\
	\end{center}
...
\begin{figure*}[htpb!]
	\begin{center}
		...
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r1-np1-curves_s10_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r1-np1-curves_s20_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r1-np1-curves_s30_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r1-np1-curves_s40_average_mono.eps}\\
	\end{center}
...
\begin{figure*}[htpb!]
	\begin{center}
		...
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-curves_s10_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-curves_s20_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-curves_s30_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-curves_s40_average_mono.eps}\\
...
% for i in $(cat bus_s40_pt*/measures | grep PSNR_final | sed "s/^-PSNR_final\ =\ "//); do  echo "scale=2;(((10^2)*$i)+0.5)/(10^2)" | bc; done
	\caption{PSNRs obtained for the classic color test sequences. See text for
		details. \pcomment{NOTE: the values in the table need to be updated!!}}
	...
	\begin{center}
		...
		\begin{tabular}{ c | l |c c | c c | c c | c c | c c | c c | c c}
			...
			\multirow{1}{*}{$10$}
			                      ...
			                      & VNLB   $s_t = 1$     & \bsic{33.16} &       33.65  & \bsic{34.69} &       35.43   & \bsic{30.74} &       31.47   & \bsic{32.18} &       33.00  & \bsic{36.75} &       38.14   & \bsic{33.21} &       33.98  & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 2$     & \bsic{34.49} &       35.01  & \bsic{36.02} &       36.82   & \bsic{32.26} &       33.15   & \bsic{34.05} &       34.87  & \bsic{37.36} & \Best{38.69}  & \bsic{33.70} & \Best{34.56} & \Bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 3$     & \bsic{34.89} &       35.49  & \bsic{36.40} &       37.40   & \bsic{32.70} &       33.49   & \bsic{34.68} &       35.47  & \bsic{37.30} & \Best{38.76}  & \Bsic{33.81} & \Best{34.64} & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 4$     & \Bsic{35.03} &       35.70  & \bsic{36.35} &       37.63   & \Bsic{32.86} &       33.52   & \Bsic{34.91} &       35.73  & \bsic{37.06} & \Best{38.74}  & \Bsic{33.81} &       34.51  & \bsic{todo } &       todo   \\\hline
...
%
			\multirow{1}{*}{$20$}
			                      ...
			                      & VNLB   $s_t = 1$     & \bsic{29.60} &       30.32  & \bsic{30.74} &       31.71   & \bsic{26.10} &       26.81   & \bsic{27.79} &       28.64  & \bsic{32.40} &       33.82   & \bsic{28.64} &       29.46  & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 2$     & \bsic{30.81} &       31.54  & \bsic{32.01} &       33.24   & \bsic{27.84} &       28.64   & \bsic{29.63} &       30.63  & \bsic{33.20} &       35.05   & \bsic{29.28} &       30.19  & \Bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 3$     & \Bsic{31.14} &       31.99  & \Bsic{32.23} &       33.81   & \bsic{28.33} &       29.18   & \bsic{30.27} &       31.38  & \bsic{33.09} &       35.29   & \Bsic{29.39} & \Best{30.35} & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 4$     & \Bsic{31.19} &       32.22  & \bsic{32.05} &       34.07   & \Bsic{28.49} &       29.36   & \Bsic{30.47} &       31.74  & \bsic{32.72} & \Best{35.30}  & \Bsic{29.35} & \Best{30.35} & \bsic{todo } &       todo   \\\hline
...
%
			\multirow{1}{*}{$30$}
			                      ...
			                      & VNLB   $s_t = 1$     & \bsic{27.33} &       28.28  & \bsic{27.96} &       29.26   & \bsic{23.57} &       24.18   & \bsic{25.36} &       26.06  & \bsic{29.53} &       31.04   & \bsic{26.11} &       26.86  & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 2$     & \bsic{28.67} &       29.65  & \bsic{29.59} &       31.10   & \bsic{25.29} &       26.04   & \bsic{27.27} &       28.17  & \bsic{30.74} &       32.69   & \bsic{26.97} &       27.76  & \Bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 3$     & \bsic{29.12} &       30.13  & \Bsic{30.09} &       31.77   & \bsic{25.82} &       26.66   & \bsic{28.00} &       29.01  & \bsic{30.88} &       33.06   & \Bsic{27.17} & \Best{28.01} & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 4$     & \Bsic{29.26} &       30.38  & \Bsic{30.13} &       32.11   & \Bsic{26.04} &       26.93   & \Bsic{28.28} &       29.43  & \bsic{30.67} & \Best{33.19}  & \Bsic{27.20} & \Best{28.08} & \bsic{todo } &       todo   \\\hline
...
%
			\multirow{1}{*}{$40$}
			                      ...
			                      & VNLB   $s_t = 1$     & \bsic{25.66} &       26.82  & \bsic{26.01} &       27.53   & \bsic{21.85} &       22.37   & \bsic{23.53} &       24.25  & \bsic{27.37} &       28.97   & \bsic{24.27} &       25.05  & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 2$     & \bsic{27.12} &       28.34  & \bsic{27.73} &       29.58   & \bsic{23.53} &       24.24   & \bsic{25.46} &       26.36  & \bsic{28.71} &       30.96   & \bsic{25.20} &       26.03  & \bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 3$     & \Bsic{27.60} &       28.84  & \bsic{28.30} &       30.32   & \bsic{24.09} &       24.90   & \bsic{26.16} &       27.26  & \bsic{28.92} &       31.42   & \Bsic{25.45} &       26.34  & \Bsic{todo } &       todo   \\
			                      & VNLB   $s_t = 4$     & \Bsic{27.75} &       29.11  & \Bsic{28.40} &       30.69   & \Bsic{24.31} &       25.19   & \Bsic{26.43} &       27.77  & \bsic{28.73} & \Best{31.57}  & \Bsic{25.50} & \Best{26.45} & \Bsic{todo } &       todo   \\\hline
...
%
	...
	\pcomment{NOTE: the values in the table need to be updated!!}}
	\label{tab:sintel}
\end{table*}
...
\bibliography{IEEEabrv,image_denoising,video_denoising,covariance_estimation}
