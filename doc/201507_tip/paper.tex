...
\begin{figure*}[htpb!]
	\begin{center}
		...
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-image_s10_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-image_s20_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/fpsnr_r2-np2-image_s30_average_mono.eps}%
...
\begin{figure*}[htpb!]
	\begin{center}
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-image_s10_average_derf.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-image_s20_average_derf.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-image_s30_average_derf.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-image_s40_average_derf.eps}\\
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-image_s10_average_mono.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/bpsnr_r1-np1-image_s20_average_mono.eps}%
