...
\begin{figure*}[htpb!]
	\begin{center}
		\includegraphics[width=.25\textwidth]{figs/params_tables/psnr_r1-np1-image_s10_bus.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/psnr_r1-np1-image_s20_bus.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/psnr_r1-np1-image_s40_bus.eps}\\
		\includegraphics[width=.25\textwidth]{figs/params_tables/time_r1-np1-image_s10_bus.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/time_r1-np1-image_s20_bus.eps}%
		\includegraphics[width=.25\textwidth]{figs/params_tables/time_r1-np1-image_s40_bus.eps}\\
	\end{center}
...
%			                      & V-BM4D-np            & \bsic{toto } &       31.67  & \bsic{toto } &       32.24  & \bsic{toto } &       33.34  & \bsic{toto } &       30.95  & \bsic{toto } &       30.95  & \bsic{toto } &       30.95  \\
%			                      & VNLB $n_t = 0$       & \bsic{toto } &       30.65  & \bsic{toto } &       32.70  & \bsic{toto } &       33.64  & \bsic{toto } &       31.39  & \bsic{toto } &       31.39  & \bsic{toto } &       31.39  \\
%			                      & VNLB $n_t = 3$       & \bsic{toto } &       31.26  & \bsic{toto } &       33.35  & \bsic{toto } &       34.25  & \bsic{toto } &       32.11  & \bsic{toto } &       32.11  & \bsic{toto } &       32.11  \\
%			                      & VNLB $n_t = 5$       & \bsic{todo } &       todo   & \bsic{todo } & \best{todo } & \bsic{todo } &       todo   & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } \\
%			                      & VNLB   $s_t = 1$     & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 2$     & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 3$     & \bsic{todo } &       todo   & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   \\
...
%			                      & V-BM4D-np            & \bsic{toto } &       35.56  & \bsic{toto } &       36.20  & \bsic{toto } &       36.90  & \bsic{toto } &       35.09  & \bsic{toto } &       35.09  & \bsic{toto } &       35.09  \\
%			                      & VNLB $n_t = 0$       & \bsic{toto } &       34.43  & \bsic{toto } &       36.70  & \bsic{toto } &       37.21  & \bsic{toto } &       35.58  & \bsic{toto } &       35.58  & \bsic{toto } &       35.58  \\
%			                      & VNLB $n_t = 3$       & \bsic{toto } &       35.04  & \bsic{toto } &       37.19  & \bsic{toto } &       37.88  & \bsic{toto } &       36.19  & \bsic{toto } &       36.19  & \bsic{toto } &       36.19  \\
%			                      & VNLB $n_t = 5$       & \bsic{34.51} &       35.28  & \bsic{36.80} & \best{37.30} & \bsic{37.22} & \best{38.11} & \bsic{35.43} & \best{36.37} & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } \\
%			                      & VNLB   $s_t = 1$     & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 2$     & \bsic{35.65} &       36.19  & \bsic{37.42} &       38.05  & \Bsic{37.86} &       38.74  & \Bsic{35.80} &       36.63  & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 3$     & \bsic{35.94} &       36.51  & \Bsic{37.57} &       38.35  & \Bsic{37.94} &       38.95  & \Bsic{35.86} &       36.79  & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   \\
...
%			                      & VNLB $n_t = 0$       & \bsic{toto } &       30.65  & \bsic{toto } &       32.70  & \bsic{toto } &       33.64  & \bsic{toto } &       31.39  & \bsic{toto } &       31.39  & \bsic{toto } &       31.39  \\
%			                      & VNLB $n_t = 3$       & \bsic{toto } &       31.26  & \bsic{toto } &       33.35  & \bsic{toto } &       34.25  & \bsic{toto } &       32.11  & \bsic{toto } &       32.11  & \bsic{toto } &       32.11  \\
%			                      & VNLB $n_t = 5$       & \bsic{30.76} &       31.49  & \bsic{32.94} & \best{33.55} & \bsic{33.69} &       34.45  & \bsic{31.58} & \best{32.35} & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } \\
%			                      & VNLB   $s_t = 1$     & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 2$     & \bsic{32.12} &       32.56  & \bsic{33.98} &       34.30  & \bsic{34.55} &       35.32  & \bsic{32.11} &       32.71  & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 3$     & \bsic{32.52} &       33.00  & \Bsic{34.15} &       34.60  & \Bsic{34.71} &       35.64  & \Bsic{32.26} &       32.97  & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   \\
...
%			                      & V-BM3D               & \bsic{     } &              & \bsic{     } &              & \bsic{     } &              & \bsic{     } &              & \bsic{     } &              & \bsic{     } &              \\
%			                      & V-BM4D-tip           & \bsic{     } & \best{     } & \bsic{     } & \best{     } & \bsic{     } & \best{     } & \bsic{     } & \best{     } & \bsic{     } & \best{     } & \bsic{     } & \best{     } \\
%			                      & V-BM4D-mp            & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%%			                      & V-BM4D-np            & \bsic{toto } &       31.67  & \bsic{toto } &       32.24  & \bsic{toto } &       33.34  & \bsic{toto } &       30.95  & \bsic{toto } &       30.95  & \bsic{toto } &       30.95  \\
%%			                      & VNLB $n_t = 0$       & \bsic{toto } &       30.65  & \bsic{toto } &       32.70  & \bsic{toto } &       33.64  & \bsic{toto } &       31.39  & \bsic{toto } &       31.39  & \bsic{toto } &       31.39  \\
%%			                      & VNLB $n_t = 3$       & \bsic{toto } &       31.26  & \bsic{toto } &       33.35  & \bsic{toto } &       34.25  & \bsic{toto } &       32.11  & \bsic{toto } &       32.11  & \bsic{toto } &       32.11  \\
%%			                      & VNLB $n_t = 5$       & \bsic{todo } &       todo   & \bsic{todo } & \best{todo } & \bsic{todo } &       todo   & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } \\
...
%			                      & V-BM4D-np            & \bsic{toto } &       27.97  & \bsic{toto } &       28.43  & \bsic{toto } &       29.69  & \bsic{toto } &       27.02  & \bsic{toto } &       27.02  & \bsic{toto } &       27.02  \\
%			                      & VNLB $n_t = 0$       & \bsic{toto } &       27.43  & \bsic{toto } &       28.88  & \bsic{toto } &       30.15  & \bsic{toto } &       27.60  & \bsic{toto } &       27.60  & \bsic{toto } &       27.60  \\
%			                      & VNLB $n_t = 3$       & \bsic{toto } &       27.97  & \bsic{toto } &       29.60  & \bsic{toto } &       30.72  & \bsic{toto } &       28.23  & \bsic{toto } &       28.23  & \bsic{toto } &       28.23  \\
%			                      & VNLB $n_t = 5$       & \bsic{27.17} &       28.11  & \bsic{28.81} &       29.78  & \bsic{29.72} &       30.82  & \bsic{27.65} & \best{28.40} & \bsic{todo } & \best{todo } & \bsic{todo } & \best{todo } \\
%			                      & VNLB   $s_t = 1$     & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 2$     & \bsic{28.44} &       29.28  & \bsic{30.18} &       30.94  & \bsic{30.87} &       32.00  & \bsic{28.21} &       28.96  & \bsic{todo } &       todo   & \bsic{todo } &       todo   \\
%			                      & VNLB   $s_t = 3$     & \Bsic{28.86} &       29.73  & \Bsic{30.43} &       31.23  & \Bsic{31.03} &       32.39  & \Bsic{28.32} &       29.23  & \Bsic{todo } &       todo   & \Bsic{todo } &       todo   \\
